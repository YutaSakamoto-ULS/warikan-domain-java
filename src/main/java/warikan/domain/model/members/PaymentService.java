...
public final class PaymentService {
   ...
   */
  public static Payment calculateMuchMembersPayment(
      Money littleMembersTotalPayment,
      Money meanMembersTotalPayment,
      TotalPayment TotalPayment,
      long sizeOfTotal) {
    var muchMembersTotalPayment =
        TotalPayment.subtract(meanMembersTotalPayment).subtract(littleMembersTotalPayment);
   ...
   */
  public static Payment calculateLittleMembersPayment(
      Payment meanPayment, LittleRatio littleRatio) {
